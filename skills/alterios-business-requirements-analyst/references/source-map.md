...
- `../../../docs/business-requirements-analyst-agent.md`: analyst role, постановка/TRZ structure, and view requirement rules.
...
For formal ГОСТ/ЕСПД output, pair this skill with the installed `gost-documentation-builder` skill. For DOCX production, pair it with the document-rendering skill available in the current Codex environment.
