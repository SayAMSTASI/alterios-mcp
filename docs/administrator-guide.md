...
- embedded Stimulsoft viewer проверять отдельно от printable render;
- release artifact publishing остаётся отдельным release-этапом; changelog
  ведётся в `CHANGELOG.md`.
