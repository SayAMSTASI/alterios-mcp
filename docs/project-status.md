...
|---|---|---|---|
| 16. Scenario tools | Next | Lead Engineer + Write Tools + Form/View + Script/BPMN + Report | Implement `alterios_create_material_module`, then `alterios_create_report_tab`, then `alterios_create_process_flow` on top of saved `plan_id` workflow. |
