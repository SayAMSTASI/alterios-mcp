...
| `alterios-form-view-surface` | Создан в `skills/alterios-form-view-surface` | view entity/field links, form tabs/actions, no-gap layout, F-pattern, role/source/style/icon validation |
