...
проекте `artx` `4e247a6b-55ef-4665-b88c-3c156fee19ba`.
...
| 17. UI/report validation and replay smoke | In progress | Lead Engineer + Report + Safety Verifier | Replay/smoke command is implemented. Remaining acceptance: close empty Stimulsoft viewer/render validation and extend form listener/bulk coverage. |
